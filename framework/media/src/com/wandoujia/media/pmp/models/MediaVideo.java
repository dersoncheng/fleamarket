...
public final class MediaVideo extends Message {
  ...
  @ProtoField(tag = 16, type = SINT64)
  public final Long duration;

  @ProtoField(tag = 17, type = SINT64)
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MediaVideo)) return false;
    MediaVideo o = (MediaVideo) other;
    return equals(id, o.id)
        ...
        && equals(resolution, o.resolution)
  ...
  public static final class Builder extends Message.Builder<MediaVideo> {
    ...
    public Builder(MediaVideo message) {
      super(message);
