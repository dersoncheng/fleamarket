...
public class LogSender {
  ...
  private static final String MUCE_URL_RAW = "http://l.wandoujia.com/muce/data/proxy?" +
      "profile=%1$s&vc=%2$s&vn=%3$s&gzip=true&encrypt=true&key_version=%4$s&log_version=%5$s";

  private static final String MUCE_URL_RAW_DEBUG = "http://10.0.75.23:8095/muce/data/proxy?" +
      "profile=%1$s&vc=%2$s&vn=%3$s&gzip=true&encrypt=true&key_version=%4$s&log_version=%5$s";
  ...
  LogSender(Context context, DatabaseLogStorage logStorage, LogConfiguration configuration) {
