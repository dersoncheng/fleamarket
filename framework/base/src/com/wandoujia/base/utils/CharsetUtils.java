 ...
 *
 * <p>
 * As of this writing, the only vendor that is recognized by this class is Docomo (identified
 * case-insensitively as {@code "docomo"}).
 * </p>
 *
...
public final class CharsetUtils {
   ...
   * code is running on). This method merely calls through to {@link #nameForVendor(String,String)},
   * passing the default vendor
   ...
   * @throws IllegalCharsetNameException thrown if {@code charsetName} has invalid syntax
   */
   ...
   * This method merely calls through to {@link #charsetForVendor(String,String)}, passing the
   * default vendor
   * as the second argument.
   *
   * @param charsetName the base character set name
   ...
   * @return {@code true} if the name corresponds to Shift-JIS or {@code false} if not
   */
