...
public class ScrollingTabContainerView extends NineHorizontalScrollView
  ...
  public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    final int maxWidth = (int) (metrics.widthPixels * 0.4f);
  ...
  public void addTab(ActionBar.Tab tab, boolean setSelected) {
    ...
    mTabLayout.addView(tabView, new IcsLinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
...
//    }
  ...
  public static class TabView extends LinearLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
      ...
      // heightMeasureSpec);
      // } else if (getMeasuredWidth() < mParent.measuredMaxTabWidth) {
      // super.onMeasure(
      // MeasureSpec.makeMeasureSpec(mParent.measuredMaxTabWidth, MeasureSpec.EXACTLY),
      // heightMeasureSpec);
      // }
      // if (mParent.measuredMaxTabWidth < getMeasuredWidth()) {
      // mParent.measuredMaxTabWidth = getMeasuredWidth();
      // }
    }

    @Override
    protected void onConfigurationChanged(Configuration newConfig) {
      mParent.measuredMaxTabWidth = 0;
    }
