...
final class ExtensionRegistry {
  ...
  private final Map<Class<? extends ExtendableMessage>, Map<Integer, Extension<?, ?>>> extensionsByTag =
      new LinkedHashMap<Class<? extends ExtendableMessage>,
      Map<Integer, Extension<?, ?>>>();
  private final Map<Class<? extends ExtendableMessage>, Map<String, Extension<?, ?>>> extensionsByName =
      new LinkedHashMap<Class<? extends ExtendableMessage>,
