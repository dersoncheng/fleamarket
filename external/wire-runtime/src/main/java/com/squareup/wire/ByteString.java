 ...
 * 
 * <p>
 * <strong>Full disclosure:</strong> this class provides untrusted input and output streams with raw
 * access to the underlying byte array. A hostile stream implementation could keep a reference to
 * the mutable byte string, violating the immutable guarantee of this class. For this reason a byte
 * string's immutability guarantee cannot be relied upon for security in applets and other
...
public final class ByteString {
  ...
  /**
   * Returns a new byte string containing the bytes of {@code data} from {@code offset} to
   * {@code offset + count - 1}, inclusive.
   */
