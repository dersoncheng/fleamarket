 ...
 * 
 * <p>
 * An extension instance is a key; it names the attribute. Use it to set a value on a message's
 * builder, or to get the value on a message.
 * 
 * <pre>
 * {@code
 * 
 ...
 * 
 * <p>
 * Application code shouldn't create extension instances directly; instead they should use the
 * generated instances created with {@code Ext_} prefixes. To serialize and deserialize extensions,
 * specify all of your {@code Ext_} classes when creating a {@link Wire} instance.
 * 
