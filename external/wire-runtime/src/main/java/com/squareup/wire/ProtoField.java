...
public @interface ProtoField {
  ...
  /**
   * The field's protocol buffer datatype, e.g., {@code Datatype#INT32}, {@code Datatype#MESSAGE},
   * or {@code Datatype#ENUM}. Defaults to {@code Datatype#MESSAGE}.
   */
   ...
   * {@link Label#REPEATED}, or {@link Label#PACKED}.
