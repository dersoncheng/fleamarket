...
public class HttpMultipart {
   ...
   * <p/>
   * This method buffers only a small amount of data in order to determine the total length of the
   * entire entity. The content of individual parts is not buffered.
   * 
