...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
  ...
  private boolean mSaveAndRestoreState = true;
	...
	public final boolean onInterceptTouchEvent(MotionEvent event) {
		...
		switch (action) {
			case MotionEvent.ACTION_MOVE: {
              ...
              if (diff != 0
                  && scrollableForChildHorizontal(this, false, (int) diff, (int) x, (int) y)) {
   ...
   */
  protected boolean scrollableForChildHorizontal(View v, boolean checkV, int dx, int x, int y) {
    if (v instanceof ViewGroup) {
      ...
      for (int i = count - 1; i >= 0; i--) {
        ...
        if (x + scrollX >= child.getLeft() && x + scrollX < child.getRight() &&
            ...
            scrollableForChildHorizontal(child, true, dx, x + scrollX - child.getLeft(),
  ...
  public void forceReset() {
	...
	protected final void refreshRefreshableViewSize(int width, int height) {
		...
		// this layout
		LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mRefreshableView.getLayoutParams();
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			ViewCompat.setLayerType(mRefreshableView, value != 0 ? View.LAYER_TYPE_HARDWARE
	...
	private void addRefreshableView(Context context, T refreshableView) {
		addViewInternal(mRefreshableView, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
    ...
    if (a.hasValue(R.styleable.PullToRefresh_ptrSaveAndRestoreState)) {
      mSaveAndRestoreState = a.getBoolean(R.styleable.PullToRefresh_ptrSaveAndRestoreState, true);
    }
