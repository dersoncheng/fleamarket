...
package com.zhangyu.fleamarket.stickygridheaders;
...
public class StickyGridHeadersGridView extends GridView implements
  ...
  private void scrollChanged(int firstVisibleItem) {
    ...
    StickyGridHeadersBaseAdapterWrapper.ReferenceView firstItem = (StickyGridHeadersBaseAdapterWrapper.ReferenceView) getChildAt(0);
    if (firstItem == null) {
      return;
    }
    ...
    if (childCount != 0) {
      ...
      for (int i = 0; i < childCount; i += mNumMeasuredColumns) {
        StickyGridHeadersBaseAdapterWrapper.ReferenceView child = (StickyGridHeadersBaseAdapterWrapper.ReferenceView) super.getChildAt(i);
        ...
        if (child.getView() instanceof StickyGridHeadersBaseAdapterWrapper.HeaderFillerView
  ...
  protected void dispatchDraw(Canvas canvas) {
    ...
    for (int i = 0; i < headerPositions.size(); i++) {
      StickyGridHeadersBaseAdapterWrapper.ReferenceView frame = (StickyGridHeadersBaseAdapterWrapper.ReferenceView) getChildAt(headerPositions
          .get(i));
      View header;
      try {
      ...
      boolean headerIsStickied = ((StickyGridHeadersBaseAdapterWrapper.HeaderFillerView) frame.getChildAt(0))
